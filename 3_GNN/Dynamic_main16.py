...
if __name__ == "__main__":
    ...
    GRAPH_DATA_FOLDER = "./Graph_Data/DoubleConv/Graph_data_MLP512_16_3Layers_L1_R45"
    NODE_FEATURE_DIM = 520 # if you only use Geo features, it should be 8.
    GNN_HIDDEN_DIM = 256
    GNN_OUTPUT_DIM = 128
    GAT_HEADS = 8
    ...
    if USE_LAMBDA_SCHEDULER:
        ...
        LAMBDA_VAL = 200.0  # 3 Layers = 50, 4 Layers = 10, if only using geo features = 50
        lambda_initial_val = LAMBDA_VAL
        logger_name = f"MLP512_16_3Layers_L1_R45_200EpochES_Lambda{LAMBDA_VAL:.2f}_LR{LEARNING_RATE:.4f}"
    ...
    checkpoint_callback = ModelCheckpoint(monitor='val_loss',
                                          dirpath=f'CheckPoints/DoubleConv/MLP512_16_3Layers_L1_R45/checkpoints_{logger_name}/',
